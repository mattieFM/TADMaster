...
app = DjangoDash(name='Example_vis', external_stylesheets=[dbc.themes.SPACELAB], add_bootstrap_links=True) 
	...
	html.Div(
        ...
        dbc.Row([
            dbc.Col(
                ...
                dbc.Collapse(
                dbc.Card([dbc.CardBody("Uploads are disabled on the example visualizations. If you wish to upload a bed, then please download this example and reupload the job. This will create a duplicate that can be altered."),
            ]),
            id="collapse-upload",
