...
app = DjangoDash(name='TADVIS_Fast', external_stylesheets=[dbc.themes.SPACELAB], add_bootstrap_links=True)
                                        ...
                                        html.Div([
                                            ...
                                            dbc.Collapse(
                                                dbc.Card([dbc.CardBody(
                                                    "Please provide your TAD .bed File. Click below to see an example Bed File."),
                                                        ...
                                                        [
                                                            ...
                                                            dbc.ModalBody(
                                                                html.Img(src='data:image/png;base64,{}'.format(
                                                                    encoded_example.decode()),
                                                                    style={'height': '75%', 'width': '75%'})
                                                            ),
                                                            dbc.ModalFooter(
                                                                dbc.Button("Close", id="close_example",
                                                                           className="ml-auto")
                                                            ),
                                                        ],
                                                        id="modal_example",
                                                    ...
                                                    html.H4("Title:"),
                                                    dbc.Input(id="upload-title", placeholder="Title",
                                                              type="text"),
                                                    dcc.Upload(
                                                        id="upload-data",
                                                        children=html.Div(
                                                    ...
                                                    dbc.Button("Upload", id='upload button', href="",
                                                               external_link=True, style=dict(display='none')),
                                                ]),
                                                id="collapse-upload",
