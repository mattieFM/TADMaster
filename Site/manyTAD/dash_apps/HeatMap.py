...
app.layout = html.Div([
    ...
    html.P("Please Note: In order to provide a detailed visualization experience heatmaps are loaded at full resolution; matrix load times are proportional to the size of the provided matrix.", style={"color": "#FF0000"}),
    # ------------------------------------------------------------------------------
    # Heat Map
    # ------------------------------------------------------------------------------
    html.Div([
                    ...
                    [
                        dbc.Card(
                            dbc.CardBody(children = html.Div([
                                dcc.Graph(id="Heat Map", style = {'width': '100%', 'height': '100%'}),], 
